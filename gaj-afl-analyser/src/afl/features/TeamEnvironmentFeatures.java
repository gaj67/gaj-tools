 ...
 * <p>
 * For technical reasons, the features from the team and environment cannot simply be concatenated, otherwise they would be linearly separable and the environment features would
 * cancel out when using a logistic classifier.
 * <p>
 * Thus, the cross-product is first taken of the environment features with the team features (producing bilinear terms), and these are concatenated with the team features (which
 * provide linear terms).
 */
