...
an arbitrary sequence is initiated at stage 0 and terminated at some random stage $N+1$.
...
$\underline{\tau}\in\{0,1,*\}$ corresponds to the delimiters $\uparrow$, $\rangle$, and $]$, respectively.
