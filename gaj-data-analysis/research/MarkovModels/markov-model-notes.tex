...
\centering
\begin{tikzpicture}[cnode/.style={draw,circle,minimum size=3em,inner sep=3pt}, onode/.style={fill=black!50, draw,circle,minimum size=1em}]
    \node (iota) at (-0.7, 0) [right] {$\stackrel{\iota_0^+}{}$};
    \node (0up) at (0, 0.9) {};
    \node[onode] (0) at (0, 0) {};
    \node[cnode] (1) at (2, 0) {$R_1$};
    \node (ldots) at (4, 0) {$\cdots$};
    \node (tup) at (6.55, 0.9) {};
    \node (tup2) at (6.55, 1.3) {};
    \node (tdown) at (6.55, -0.7) {};
    \node[cnode] (t) at (6, 0)  {$R_t$};
    \node (rdots) at (8, 0) {$\cdots$};
    \node[cnode] (N) at (10, 0)  {$R_N$};
    \node (Np1up) at (12, 0.9) {};
    \node[onode] (Np1) at (12, 0) {};

    \draw[->] (0) edge node [pos=0.5, above] {$\stackrel{\tau^-_1}{}$}  (1) ;
    \draw[->] (1) edge node [pos=0.5, above] {$\stackrel{\tau^-_2}{}$}  (ldots) ;
    \draw[->] (ldots) edge node [pos=0.5, above] {$\stackrel{\tau^-_t}{}$}  (t) ;
    \draw[->] (t) edge node [pos=0.5, above] {$\stackrel{\tau^-_{t+1}}{}$}  (rdots) ;
    \draw[->] (rdots) edge node [pos=0.5, above] {$\stackrel{\tau^-_{N}}{}$} (N) ;
