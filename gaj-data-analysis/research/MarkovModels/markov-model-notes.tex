...
& = &
   \frac{p(\tau_{n+1}\!=\!\underline{\tau}',\underline{\iota},\vec{s},\vec{x},\underline{\tau}\,|\,\theta) }
           {p(\underline{\iota},\vec{s},\vec{x},\underline{\tau}\,|\,\theta) }
\nonumber\\& = &
\delta(\underline{\tau}'\!=\!\underline{\tau})\,
\frac{p(\underline{\iota},\vec{s},\vec{x},\underline{\tau}'\,|\,\theta) }
       {p(\underline{\iota},\vec{s},\vec{x},\underline{\tau}\,|\,\theta) }
\nonumber\\& = &
\delta(\underline{\tau}'\!=\!\underline{\tau})\,
...
\,,
\end{eqnarray}
from equations~\eqref{eq:forward-backward} and \eqref{eq:beta_n}.
