...
\begin{eqnarray}
\beta_{t}(\vs_{t-m+1,t}) & = & 
 p(\uvs_{t+1,n},\uvx_{t+1,n},\ut\,|\,\vs_{t-m+1,t})
\nonumber\\& = &
\sum_{s_{t+1}\in{\cal S}} \delta(s_{t+1}\!=\!\us_{t+1})\,
p(\tm_{t+1},s_{t+1}\,|\,\vs_{t-m+1,t})\,p(\ux_{t+1}\,|\,\vs_{t-\ell+2,t+1})\,\beta_{t+1}(\vs_{t-m+2,t+1})
\,,
\end{eqnarray}
for $t=n-1,\ldots,m$.
*** put back to t->t-1 ***
