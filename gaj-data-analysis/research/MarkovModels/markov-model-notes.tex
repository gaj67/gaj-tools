...
and so define
\begin{eqnarray}
 p(\underline{\iota},\tau^-_1,s_1) & = & \sum_{\iota=0}^{1}\delta(\iota\!=\!\underline{\iota}) \, p(\iota,\tau^-_1,s_1)\,,
\end{eqnarray}
...
\nonumber\\&=&
p(\underline{\iota},\tau^-_1,s_1,\underline{x}_1)~=~p(\underline{\iota},\vec{s}_1,\underline{\vec{x}}_1)\,,
\label{eq:alpha_1}
\end{eqnarray}
