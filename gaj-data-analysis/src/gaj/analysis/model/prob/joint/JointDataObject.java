...
import gaj.analysis.model.prob.marginal.MarginalDataObject;

/**
 * Encapsulates the output of a {@link JointDataModel}.
 * <p/>
 * Note: Any additional information, such as a gradient matrix, will be computed
 * against the joint probabilities.
 */
public interface JointDataObject extends MarginalDataObject, DiscriminativeDataObject {
