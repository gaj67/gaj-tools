 ...
 * <p/>
 * In addition, the data point has a specified weighting. This could, for example, represent the number of times this particular vector of feature values occurred. Alternatively,
 * it could be used to indicate ambiguity of the underlying classification, e.g. the same feature vector is repeated in a number of data points with different class indices and
 * proportional weights that sum to 1.
 */
