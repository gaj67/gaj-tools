 ...
 * <p/>Note: These parameters need not take the form of a single vector,
 * but must be representable as a vector for external manipulation, 
 * e.g. parameter search for score optimisation.
 */
public interface ParameterisedClassifier extends Classifier {

	/**
	 * Obtains the total number of numerical values comprising the classifier parameters.
	 * 
